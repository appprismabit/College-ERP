                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="info-box shadow-lg">
                                    <span class="info-box-icon bg-dark"><i class="fa fa-balance-scale text-black"></i></span>
                                    <div class="info-box-content">
                                        <span class="info-box-number" id="users"></span>
                                        <span class="info-box-text">L.L.B</span>
                                        <a href="<?php echo BASE_URL; ?>/Student/LLB" class="info-box-text">More Info <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="info-box shadow-lg">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-number" id="users"></span>
                                        <span class="info-box-text">Master of Laws</span>
                            ...
                            <div class="col-3">
                                <div class="info-box shadow-lg">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-number" id="users"></span>
                                        <span class="info-box-text">BALLB {Hons}</span>
                                        <a href="<?php echo BASE_URL; ?>/Admission/index" class="info-box-text">More Info <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="info-box shadow-lg">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-number" id="users"></span>
                                        <span class="info-box-text">L.L.B {Hons}</span>
                                        <a href="<?php echo BASE_URL; ?>/Admission/index" class="info-box-text">More Info <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
