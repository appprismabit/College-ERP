            ...
            <div class="content-wrapper">
                ...
                <section class="content text-sm">
                    <div class="container-fluid">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12 col-md-2">
                                                <a href="#admission_list" data-toggle="collapse" style="text-decoration: none; color: black;">
                                                    <div class="card shadow-lg text-center card-outline card-primary p-2">
                                                        <i class="fa fa-list fa-sm"></i>
                                                        <!-- Text below the image -->
                                                        <span class="text-xs mt-2">Admission List</span>
                        ...
                        <div id="accordion">
                            <!-- STUDENT LIST -->
                            <?php include BASE_PATH . '/online_admission/admission_list.php'; ?>

                        </div>

                        <?php include BASE_PATH . '/online_admission/admission_form.php'; ?>
